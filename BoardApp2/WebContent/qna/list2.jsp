...
<%	
	...
	int totalRecord=list.size(); //총 레코드 수 , 실제 DB에 있는 데이터 수! 
	...
	//아래의 코드는 아무때나 하는게 아니라, 누군가가 파라미터를 넘겼을때만 해야함 .. 페이지 넘버를 클릭한 경우를 전제로 숫자화 시키는 코드로!
	//따라서 아무것도 누르지 않은 최초의 접속인 경우에
	...
	int curPos=(currentPage-1)*pageSize;//현재페이지에 업로드된 게시판의 시작 번호
