 ...
 * Generated at: 2020-12-14 06:19:11 UTC
...
Board board=(Board)list.get(curPos++); 
      ...
      out.write("\t\t\t<td>");
      out.print(num--);
      out.write("</td>보드앱이랑 같이쓰니까 서버가 중복돼서 오류나서 따로했어요 \r\n");
      out.write("\t\t\t<td><img src=\"/data/");
      out.print(board.getFilename());
      out.write("\" width=\"50px\"></td>\r\n");
      out.write("\t\t\t<td><a href=\"/board/detail.jsp?board_id=");
      ...
      out.write("\t\t\t\t<button onClick=\"location.href='http://localhost:9999/MySite/board/regist_form.jsp'\">글등록</button>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t</table>\r\n");
      out.write("</body>\r\n");
